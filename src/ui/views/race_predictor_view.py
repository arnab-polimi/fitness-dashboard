...
def render_race_predictor_view(
    ...
    render_view_header(
        title="Race Predictor & Training Pace Calculator",
        caption="Jack Daniels VDOT tables & Pete Riegel endurance power formulas calibrated to your Chronic Training Load (CTL).",
        icon_name="running",
    )

    # Race Predictions Section
    render_section_header("Projected Race Capabilities", icon_name="running")
    ...
    render_section_header("Jack Daniels Training Paces")
    ...
    render_section_header("Interactive Custom VDOT Calculator")
    with st.container():
